...
# Test data
INSERT INTO USERS (username, nickname, firstname, lastname, email, password, language_code, authority) # Password: admin
VALUES ('admin', 'Admin', null, null, 'admin@davidea.eu', '$2a$10$6xFxTmE98R8o8YFpjyaBzeSfWck3bxScg.AMfrKUwl6sDfqSi7tC6', 'en-US', 'ROLE_ADMIN');
INSERT INTO USERS (username, nickname, firstname, lastname, email, password, language_code, authority) # Password: avocado_ce
VALUES ('davideas', 'Davideas', 'David', 'Rock', 'davide@davidea.eu', '$2a$10$n7yElcquhL.cwgiV2..xw.F8UsHAB1FC/50o7VXlwT5VRuAN7IfSi', 'it-IT', 'ROLE_RESTAURANT');
INSERT INTO USERS (username, nickname, firstname, lastname, email, password, language_code, authority) # Password: avocado_ce
VALUES ('jonnydoe', 'Jonny', 'John', 'Doe', 'jonny@doe.com', '$2a$10$eFrnhYicQ.fmfopfZP7lnuA5sW5RRWtOAR9jWqbwrz55VjTIbmDA6', 'en-US', 'ROLE_USER');

INSERT INTO RESTAURANTS (user_id, name, country_code, language_code, currency_code, latitude, longitude, display_city, display_email, display_phone, website, tables, places, description)
VALUES (2, 'Il Pasticcio', 'BE', 'fr-BE', 'EUR', '50.838944', '4.370902', 'Brussels', 'info@ilpasticcio.be', '+32 2 512.62.52', 'www.ilpasticcio.be', 25, 60, 'Italian Restaurant');

INSERT INTO MENUS (restaurant_id, order_id, title_trans_id, status) VALUES (1, 1, 1, 'CREATED');
